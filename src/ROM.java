...
public class ROM{
	...
	public void load(String fileName){
		System.out.println("ROM.load() - Iniciando carregamento: " + fileName);
		...
		if(b==null || b.length==0){
			...
			System.out.println("ROM.load() - Erro ao carregar arquivo.");
			valid = false;
			
		}

		System.out.println("Tamanho do arquivo: " + (b != null ? b.length : 0) + " bytes");
		...
		//System.out.println("Header: " + new String(header, 0, 4));
		System.out.println("PRG ROM Size: " + romCount + " bancos (16KB cada)");
		System.out.println("CHR ROM Size: " + vromCount + " bancos (8KB cada)");
	...
	public MemoryMapper createMapper(){
		...
		nes.gui.showErrorMsg("Mapper not supported yet.");
		return new MapperDefault();
