...
public class InputDialog extends JDialog {
    ...
    public InputDialog(Frame parent, KbInputHandler kbHandler, JoystickManager joyManager, int playerId) {
    ...
    for (int a = 0; a < buttonNames.length; a++) {
        ...
        configButton.addActionListener(e -> {
            ...
            KeyCapture captureDialog = new KeyCapture(this, buttonNames[i]);
    ...
    private void captureKey(int nesButton, JButton button, String buttonName) {
        KeyCapture captureDialog = new KeyCapture(this, buttonName);
        captureDialog.setVisible(true);
